...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/jeqo.github.io/peru-constitucion/flexsearch.min.js');loadScript('/jeqo.github.io/peru-constitucion/en.search-data.min.bb32abdb304f30e8389cd724a6fdcf2dceaf1b02be9ae317fae6c2c05e36f85b.js',function(){input.required=false;search();});}
